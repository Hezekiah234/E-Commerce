...
// import vendor1 from "../assets/image/vendor-1.jpg"
// import vendor2 from "../assets/image/vendor-2.jpg"
// import vendor3 from "../assets/image/vendor-3.jpg"
// import vendor4 from "../assets/image/vendor-4.jpg"
// import vendor5 from "../assets/image/vendor-5.jpg"
// import vendor6 from "../assets/image/vendor-6.jpg"
// import vendor7 from "../assets/image/vendor-7.jpg"
// import vendor8 from "../assets/image/vendor-8.jpg"
        ...
        <div className="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div className="col-lg-4">
                <a href="" className="text-decoration-none">
                    <span className="h1 text-uppercase text-primary bg-dark px-2">Hezzy</span>
    ...
    <div className="container-fluid bg-dark mb-30">
        <div className="row px-xl-5">
            <div className="col-lg-3 d-none d-lg-block">
                <a className="btn d-flex align-items-center justify-content-between bg-primary w-100" data-toggle="collapse" href="#navbar-vertical" style={{height:"65px", padding:"30px"}}>
                    <h6 className="text-dark m-0"><i className="fa fa-bars mr-2"></i>Categories</h6>
                    <i className="fa fa-angle-down text-dark"></i>
                </a>
                <nav className="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style={{width: "100%", zIndex:"999"}}>
